...
export function CinemaMode({
	...
	return (
		<button
			...
			className='z-10 absolute top-6 right-6 p-4 bg-[#0f111a]/60 border border-white/10 backdrop-blur-2xl rounded-2xl text-white shadow-2xl hover:bg-[#0f111a]/80 hover:border-white/20 transition-all active:scale-95'
		>
			{isCinema ? (
