	...
	return (
		<>
			<button
				...
				className="btn-add-note fixed bottom-8 right-8 z-50 p-4  rounded-2xl shadow-[0_0_20px_rgba(249,115,22,0.4)] hover:scale-110 transition-all active:scale-95 group"
			>
